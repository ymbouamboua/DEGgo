...
Support for additional organisms is currently under development. Future releases will expand compatibility to livestock, model organisms, and non-model species through integration of additional Bioconductor annotation databases and custom annotation workflows.

# Custom annotation databases

Advanced users may provide any compatible AnnotationDbi database through the orgdb argument:
