...
<p align="center">
  <img src="../man/figures/DEGgo_workflow.png"
       alt="DEGgo bulk RNA-seq workflow from raw counts and metadata through quality control, differential expression analysis, Gene Ontology enrichment, visualization and HTML report generation"
       width="700">
</p>
...
For pairwise analysis, DEGgo can build a comparison variable from multiple metadata columns:
...
DEGgo can automatically generate an HTML or PDF report at the end of `run_deggo()`.
